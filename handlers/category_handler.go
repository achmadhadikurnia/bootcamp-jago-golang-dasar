...
// GetAll buat handle GET /api/categories
...
// Create buat handle POST /api/categories
...
// GetByID buat handle GET /api/categories/{id}
...
// Update buat handle PUT /api/categories/{id}
...
// Delete buat handle DELETE /api/categories/{id}
